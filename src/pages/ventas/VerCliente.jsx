        ...
        <div className="card">
          <div style={{ textAlign: "center", padding: "20px 0 12px" }}>
            <div style={{ width: 64, height: 64, borderRadius: "50%", background: "#E3EEF9",
              ...
              <FaUser style={{ color: "#0062B7", fontSize: 28 }} />
            </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12, padding: "0 4px 8px" }}>
            <div style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
              ...
              <div>
                ...
                <a href={`mailto:${cliente.correo}`} style={{ color: "#0062B7", wordBreak: "break-all" }}>{cliente.correo}</a>
              </div>
            </div>
            <div style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-around", paddingBottom: 8 }}>
            <div style={{ textAlign: "center" }}>
              <div style={{ fontSize: 22, fontWeight: 700, color: "#0062B7" }}>{notas.length}</div>
              <div style={{ fontSize: 11, color: "#9ca3af" }}>Notas de venta</div>
            </div>
            <div style={{ textAlign: "center" }}>
              <div style={{ fontSize: 22, fontWeight: 700, color: "#2C9826" }}>
              ...
              <table className="table">
                ...
                <tfoot>
                  <tr>
                    ...
                    <td colSpan={2} style={{ fontWeight: 700, color: "#2C9826" }}>
                      Bs. {notas.reduce((acc, n) => acc + Number(n.montoTotal ?? 0), 0).toFixed(2)}
                    </td>
                  </tr>
                </tfoot>
